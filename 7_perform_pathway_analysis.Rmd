...
output_dir <- paste(comparison,'pathway',feature.types[1],sep='_')
...
```{r}
joint_posteriors <- readRDS(file.path(posteriors_dir,
...
for (drug_for_biomarkers in all_drugs) {
  output_dir <- file.path(output_dir,drug_for_biomarkers)
  dir.create(output_dir,showWarnings = FALSE)
